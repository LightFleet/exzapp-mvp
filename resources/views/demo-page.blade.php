...
@section('stylesheets')
    <link rel="stylesheet" href="{{asset('demos/freelancer/css/fonts.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{asset('demos/freelancer/freelancer.css')}}" type="text/css" />

    <meta name="viewport" content="width=device-width, initial-scale=1" />

    <link rel="stylesheet" href="css/animations/css/colors.php?color=f7c25e" type="text/css" />
@endsection
        ...
        <div id="header-wrap">
            <div class="container">
                <div class="header-row">
                    ...
                    ============================================= -->
                    <div id="logo">
                        <a href="demo-freelancer.html" class="standard-logo"><img src="demos/freelancer/images/logo.png" alt="Canvas Logo"></a>
                        <a href="demo-freelancer.html" class="retina-logo"><img src="demos/freelancer/images/logo@2x.png" alt="Canvas Logo"></a>
                    </div><!-- #logo end -->
            ...
            <div class="section mb-0 pt-3 pb-0" style="background-color: #F4F4F4; margin-top: 150px; overflow: visible;">
                ...
                <div class="container">
                    <div class="row justify-content-center text-center mt-5">
                        <div class="col-lg-6">
                            <div>
                                <h3 class="font-weight-bolder h1 mb-4">Graphics Designer & Frontend Developer, Based in <span class="gradient-text gradient-horizon">Germany</span></h3>
                ...
                <div class="row col-mb-30 mt-5">
                    <div class="col-md-4">
                        <div class="d-flex align-items-center justify-content-center">
                            <div class="counter counter-xlarge text-dark font-weight-bolder"><span data-from="1" data-to="15" data-refresh-interval="2" data-speed="600"></span></div>
                    ...
                    <div class="col-md-4">
                        <div class="d-flex align-items-center justify-content-center">
                            <div class="counter counter-xlarge text-dark font-weight-bolder"><span data-from="4" data-to="83" data-refresh-interval="50" data-speed="1500"></span></div>
